...
git clone -b opensuse --single-branch https://github.com/Van-Der-Toorn-Geertse/vdtg-rmm.git /opt/vdtg-rmm && \
cd /opt/vdtg-rmm/bin && \
chmod +x vdtg-rmm && \
./vdtg-rmm
...
sudo git clone -b opensuse --single-branch https://github.com/Van-Der-Toorn-Geertse/vdtg-rmm.git /opt/vdtg-rmm && \
cd /opt/vdtg-rmm/bin && \
