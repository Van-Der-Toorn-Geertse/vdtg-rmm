...
apt install git -y && git clone -b ubuntu --single-branch https://github.com/Van-Der-Toorn-Geertse/vdtg-rmm.git /opt/vdtg-rmm && cd /opt/vdtg-rmm/bin && chmod +x vdtg-rmm && ./vdtg-rmm

Zonder root:

sudo apt install git -y && sudo git clone -b ubuntu --single-branch https://github.com/Van-Der-Toorn-Geertse/vdtg-rmm.git /opt/vdtg-rmm && cd /opt/vdtg-rmm/bin && sudo chmod +x vdtg-rmm && sudo ./vdtg-rmm